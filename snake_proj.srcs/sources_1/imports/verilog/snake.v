...
module snake(
	...
	wire [15:0] scores_bcd = 1000*scores[15:12] + 100*scores[11:8] + 10*scores[7:4] + scores[3:0];
    ...
    begin
    	if (count_two>=40000000) 
			count_two<=0;
    	else 
			count_two<=count_two+1;
    	
    	if (game_status==INITIALIZING) begin
			snake_piece_is_display<=32'b00000000_00000000_00000000_00000011;
			snake_x[0]<=27;
			snake_y[0]<=11;
			snake_x[1]<=27;
			snake_y[1]<=12;
    	...
    	// 闪烁
			if (count_two==20000000) 
				...
				snake_piece_is_display<=snake_piece_is_display_origin;
    	end
